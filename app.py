...
<table id="bugTable"><thead><tr><th>ID</th><th>Title</th><th>Status</th><th>Priority</th><th>Created_at</th><th>Action</th></tr></thead><tbody></tbody></table>
...
async function loadBugs(){
    ...
    bugs.forEach(b => {
        ...
        <td>${b.id}</td><td>${b.title}</td><td>${b.status}</td><td>${b.priority}</td><td>${b.created_at}</td>
        <td>
